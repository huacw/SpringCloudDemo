...
public class CuratorFrameworkClient {
    private final Logger logger = Logger.getLogger(CuratorFrameworkClient.class);
    ...
    public void init() {
        ...
        logger.debug(String.format("zookeeper registry center init, server lists is: %s.", zkConfig.getServerLists()));
